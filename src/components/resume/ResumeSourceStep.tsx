...
export function ResumeSourceStep() {
  ...
  const { setResume, setOriginalResume, nextStep, llmSettings, setError } =
    useResumeStore();
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-lg font-semibold">Choose Resume Source</h2>
        <p className="text-sm text-muted-foreground">
          Upload an existing PDF resume or start from a template
        </p>
      </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between text-sm">
                <span className="font-medium">Parsing progress</span>
                <span className="tabular-nums font-medium text-brand-accent">
                  {percent}%
                </span>
              </div>
              <SmoothProgressBar value={smoothPercent} />
              <p className="text-sm text-muted-foreground">
