...
export function GenerateCvGenerateStep() {
  ...
  if (!started) {
    return (
      <StepShell
        title="Choose Cover Letter Voice"
        description={`Pick how your cover letter should sound for ${jobDetails.role} at ${jobDetails.company}`}
        actions={
      ...
      >
        <StepChoice
          ...
          description="Your uploaded resume is used as source facts only — it will not be rewritten."
        >
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap items-center gap-2 rounded-lg border bg-background px-4 py-3 text-sm">
              ...
              <Badge variant="secondary">
                {getToneLabel(generationStyle.coverLetterTone)}
              </Badge>
            </div>
  ...
  return (
    <StepShell
      ...
      description={`${getToneLabel(generationStyle.coverLetterTone)} voice`}
      actions={
        <Button
          variant="outline"
          size="sm"
